...
int main(int argc, char **argv)
{
    ...
    */
    ...
    ros::ServiceClient robot_grip_client = n.serviceClient<chessmate::move_piece>("/move_piece");
    chessmate::move_piece robot_grip_request;
    ...
    while (true)
    {
        ...
        */
        ...
        ROS_INFO_STREAM("TAKE: " << take_place_square << " PUT: " << put_place_square);
        ...
        if (is_put_place_full)
        {
            ...
            robot_grip_request.request.move_from = put_place_square;

            // TODO: All discarded pieces are placed to the right of the chessboard, a place
            // calculated by giving "j4" as argument. This is a temporary solution since robot 
            // tries to put a second discarded piece on top of the first one. The old chessmate code 
            // discards pieces by dropping pieces from a higher point while this code places discarded 
            // pieces on the table. 
            robot_grip_request.request.move_to = "j4";
            robot_grip_client.call(robot_grip_request);
        }

        robot_grip_request.request.move_from = take_place_square;
        robot_grip_request.request.move_to = put_place_square;
        robot_grip_client.call(robot_grip_request);
